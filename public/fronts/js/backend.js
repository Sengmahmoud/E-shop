...
function()
{
	if($(this).attr('required')=="required"&&$(this).attr('type')!="password"&&$(this).data('class')=="user")
  {
	  $(this).after('<span class="adminMarking">*</span>');
  }
  if($(this).attr('type')=="password"&&$(this).data('class')=="pass")
  {
	 $(this).after('<span class="adminEye"><i class="fa fa-eye"></i></span>');
  }
  if($(this).attr('required')==="required"&& $(this).attr('type')!="password"&& $(this).data('class')!="user")
  {
